...
public class AddressBook {
    ...
    /* We use a HashMap<K, V> to store details of a single person.
     * The enums given below are the keys for the different data elements of a person
     * used by the internal HashMap<K, V> storage format.
     * For example, a person's name is stored as the value associated with the key ``NAME''.
     */
